...
# ==================== 10 PRODUCTION-МОДЕЛЕЙ GROQ (СТАБИЛЬНЫЕ) ====================
MODEL_LIST = [
    "llama-3.3-70b-versatile",              # 1. Llama 3.3 70B (универсальная)
    "llama-3.1-8b-instant",                 # 2. Llama 3.1 8B (быстрая)
    "meta-llama/llama-4-scout-17b-16e-instruct", # 3. Llama 4 Scout 17B (новинка)
    "openai/gpt-oss-120b",                  # 4. GPT-OSS 120B (код)
    "openai/gpt-oss-20b",                   # 5. GPT-OSS 20B (быстрый код)
    "mistral-saba-24b",                     # 6. Mistral Saba 24B (многоязычная)
    "qwen-2.5-32b",                         # 7. Qwen 2.5 32B (код и языки)
    "moonshotai/kimi-k2-instruct",          # 8. Kimi K2 (длинный контекст)
    "deepseek-r1-distill-llama-70b",        # 9. DeepSeek R1 70B (рассуждения)
    "qwen-2.5-coder-32b"                    # 10. Qwen 2.5 Coder 32B (проф. код)
]
...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        f"🤖 Groq AI Router | 10 Production моделей\n\n"
...
async def main():
    ...
    print("🚀 Groq Bot started | 10 Production models")
