...
# ==================== HEALTH CHECK И ЗАПУСК (исправлено для Render) ====================
...
async def main():
    ...
    # 1. Запускаем health check сервер и ждём его готовности
    await start_web_server()

    # 2. Даём Render время на детект порта (увеличено до 10 секунд для надёжности)
